...
Requirements:
 * [node-gyp for Windows](https://github.com/nodejs/node-gyp#on-windows)  (the easies way to get it is with `npm --vs2015 install --global --production windows-build-tools`)
